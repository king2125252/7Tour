...
class PhotoWrite {
	...
	public static void main(String argv[]) {
		...
		String userid = "root";
		String passwd = "02021";
		String photos = "src/main/webapp/front-end/article/image/artpic"; //測試用圖片已置於【專案錄徑】底下的【/7tour/forum_assert/article/artpic】目錄內
		String update = "update article set art_pic =? where art_Id=?";
