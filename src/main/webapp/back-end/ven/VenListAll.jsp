...
List<VendorVO> list = venSvc.getAll();
	...
	<div class="right">
		...
		<div class="function">
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/VenServlet" name="form1">
				<label for="search1">廠商編號: </label> <input type="text" name="ven_id"
					style="width: 130px;"> <label for="search2">名稱: </label> <input
					type="text" name="ven_name" style="width: 130px;"> <label
					for="search3">統編: </label> <input type="text" name="ven_taxnum"
					style="width: 130px;"> <label for="search4">地區: </label> <input
					type="text" name="ven_location" style="width: 130px;"> <label
					for="search5">狀態: </label> <select name="ven_status">
					<option value=""></option>
		...
		<div class="workplace">
			...
			<main class="head">
				<table id="table_id" class="display">
					...
					<tbody>
						<c:forEach var="vendorVO" items="${list}">
