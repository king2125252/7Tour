            ...
            <div class="col-sm-6 col-md-4 col-md-offset-4" style="margin-bottom: 15px;">
                ...
                <div class="account-wall">
                    ...
                    <form class="form-signin"  METHOD="post" ACTION="<%=request.getContextPath()%>/EmpServlet">
						<input type="text" class="form-control" placeholder="請輸入員工編號" required autofocus name="empNo" value="300015">                        <input type="password" class="form-control" placeholder="請輸入密碼" required name="empPw" value="123456">
