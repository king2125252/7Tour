			...
			<div class="modal-body">
				<div class="container">
					<div class="row m-2">
							...
							<input type="text" name="loc_name" maxlength="15" id="aloc_name" class="col-6" placeholder="必填" value="竹圍漁港" required>
					</div>
					...
					<div class="row m-2">
							...
							<input type="text" name="address" id="addAddress" maxlength="30" class="col-6" value="桃園市大園區漁港路451巷25號" placeholder="必填" required>
					</div>
					<div class="row m-2 ">
							<label for="aphone" class="col-4">連絡電話 : </label>
							<input type="text" name="phone" maxlength="15" class="col-6" id="aphone" value="033832308">
					</div>
