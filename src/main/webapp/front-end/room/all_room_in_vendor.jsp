        ...
        <div class="row">
            <div class="col-9">
                ...
                <div class="d-flex mt-4">
                    ...
                    <a href="" class="text-decoration-none fs-5"><img src="<%=request.getContextPath()%>/front-end/images/google-maps.png" class="mb-2">查看地圖</a>
                </div>
            </div>
            <div class="border border-secondary rounded-3 d-flex ms-auto" style="width:190px;">
    ...
    <div class="container px-5 my-3">
        <div class="row border border-secondary p-2">
            ...
            <div class="col-5 ms-3 d-flex flex-column ">
                <h4 class="fw-bold my-1">${room.roomName}</h4>
            ...
            <h4 class="col-3 text-end">$<fmt:formatNumber type="number" pattern="#,###" value="${room.roomPrice}" />/<span style="font-size:12px; font-weight:bold;">1間</span></h4>
        </div>
    </div>
	</c:forEach>
