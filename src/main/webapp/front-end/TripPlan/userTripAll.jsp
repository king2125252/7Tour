        ...
        <form action="trip.do" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-outline mb-4">
              ...
              <input type="text" id="groupTopic" class="form-control" name="trip_name" value="台灣一日遊" required />
            </div>

            <div class="d-flex justify-content-around">
              <div class="form-outline mb-4">
                <label class="form-label" for="tripStart">出發日期 : </label>
                <input type="text" id="tripStart" class="form-control" name="start_date" required value="2023-03-17" onkeypress="$(this).val('')" />
              </div>

              <div class="form-outline mb-4">
                <label class="form-label" for="tripEnd">結束日期 : </label>
                <input type="text" id="tripEnd" class="form-control" name="end_date" required value="2023-03-19" onkeypress="$(this).val('')" />
              </div>
            </div>
