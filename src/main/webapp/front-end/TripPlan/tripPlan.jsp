    ...
    <div class="row">
      ...
      <div class="col-3 overflow-auto scroll-style" id="rightContent" style="height: calc(100vh - 66px);">
        <div class="row align-items-center p-0" style="background-color: rgba(38, 112, 180, 0.2); height: 10%;">
          <div class="col-2">
            <a href="<%=request.getContextPath()%>/front-end/TripPlan/userTripAll.jsp" class="btn"><i class="bi bi-arrow-left"></i></a>
          </div>
          ...
          <!-- loc info start -->
            ...
            <div class="tab-pane fade container  overflow-auto" style="height: calc(100vh - 66px - 65px);" id="cusLoc"
              ...
              <div class="row">
                ...
                <input type="text" class="col-12 newLoc-input" name="loc_name" id="cusLocName" placeholder="請輸入地點名稱" value="新竹城隍廟">
                <input type="text" class="col-12 newLoc-input" name="address" id="cusLocAddress" placeholder="*請輸入地址" value="新竹市北區中山路75號">
                <input type="number" class="col-12 newLoc-input" name="phone" id="cusLocPhone" placeholder="請輸入電話" value="035223666">
          ...
          <div class="tab-content h-100 overflow-auto p-0">
            <div class="tab-pane fade show active p-3 overflow-auto" id="mbr" role="tabpanel" aria-labelledby="mbr-tab"
              ...
              <div class="row align-items-center">
                  <input class="col-9 newLoc-input" type="text" name="USER_ACCOUNT" id="addUserAccount" placeholder="請輸入好友帳號" value="456yyhhjj@yahoo.com.tw	">
              ...
              <div class="row">
                <h5 class="col-12 fw-bold mt-2 mb-0" id="invitingUser">邀請中</h5>
              <c:forEach var="tripMbrVO" items="${tripMbr}">
            ...
            <!-- trip notes start -->
            <div class="tab-pane fade overflow-hidden" id="notes" role="tabpanel" aria-labelledby="notes-tab">
              <div class="row">
                <div class="col m-2">
