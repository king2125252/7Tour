	...
	<div class="container mb-2 mt-1">
		<form action="<%=request.getContextPath()%>/article" method="post"
			...
			<div class="row row-cols-sm-1 row-cols-lg-5 g-2 h-250px ">
				<c:forEach var="articleVO" items="${articleVOlist}">
					<a
